...
public class Weather extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Weather\",\"namespace\":\"eu.bausov.kafkaavro.model\",\"doc\":\"A weather reading.\",\"fields\":[{\"name\":\"station\",\"type\":\"string\",\"order\":\"ignore\"},{\"name\":\"time\",\"type\":\"long\"},{\"name\":\"temp\",\"type\":\"int\"},{\"name\":\"price\",\"type\":{\"type\":\"string\",\"java-class\":\"java.math.BigDecimal\"}}]}");
  private static final long serialVersionUID = 2920766999338689701L;
   ...
   */
  public static eu.bausov.kafkaavro.model.Weather.Builder newBuilder() {
    return new eu.bausov.kafkaavro.model.Weather.Builder();
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static eu.bausov.kafkaavro.model.Weather.Builder newBuilder(eu.bausov.kafkaavro.model.Weather.Builder other) {
    if (other == null) {
      return new eu.bausov.kafkaavro.model.Weather.Builder();
    } else {
      return new eu.bausov.kafkaavro.model.Weather.Builder(other);
    }
  }
   ...
   * @return A new Weather RecordBuilder
   */
  public static eu.bausov.kafkaavro.model.Weather.Builder newBuilder(eu.bausov.kafkaavro.model.Weather other) {
    if (other == null) {
      return new eu.bausov.kafkaavro.model.Weather.Builder();
    } else {
      return new eu.bausov.kafkaavro.model.Weather.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Weather>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.bausov.kafkaavro.model.Weather.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(eu.bausov.kafkaavro.model.Weather other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.station)) {
        this.station = data().deepCopy(fields()[0].schema(), other.station);
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder setStation(java.lang.CharSequence value) {
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder clearStation() {
      station = null;
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder setTime(long value) {
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder clearTime() {
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder setTemp(int value) {
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder clearTemp() {
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder setPrice(java.math.BigDecimal value) {
     ...
     * @return This builder.
     */
    public eu.bausov.kafkaavro.model.Weather.Builder clearPrice() {
      price = null;
